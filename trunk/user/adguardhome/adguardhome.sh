...
curl -k -s -o /tmp/AdGuardHome/AdGuardHome --connect-timeout 10 --retry 3 https://cdn.jsdelivr.net/gh/MeIsReallyBa/padavan-4.4@main/trunk/user/adguardhome/AdGuardHome
